(function () {
  ...
  function renderSettingsOverviewSection() {
    ...
    const completion = (window.CBV2.settingsProfile && window.CBV2.settingsProfile.computeCompleteness)
      ? window.CBV2.settingsProfile.computeCompleteness(user, profile, roleProfile)
      : 0;
    ...
    return `
      ${window.CBV2.settingsProfile && window.CBV2.settingsProfile.renderHero ? window.CBV2.settingsProfile.renderHero() : ""}
      ${candidateIntelHtml}
      ...
      <section class="page-container">
        ...
        <section class="settings-studio-layout">
          ...
          <section class="settings-studio-main">
            ...
            ${showMe && window.CBV2.settingsProfile && window.CBV2.settingsProfile.renderHero
              ? window.CBV2.settingsProfile.renderHero()
              : ""}
            ${showMe && window.CBV2.settingsProfile && window.CBV2.settingsProfile.render
              ? window.CBV2.settingsProfile.render()
              : ""}
  ...
  window.CBV2.afterRender.settings = function () {
    ...
    bindForm();
    if (window.CBV2.settingsProfile && typeof window.CBV2.settingsProfile.bind === "function") {
      window.CBV2.settingsProfile.bind();
    }
    ...
    if (window.CBV2.settingsAppearance && typeof window.CBV2.settingsAppearance.bind === "function") {
      window.CBV2.settingsAppearance.bind();
    }
