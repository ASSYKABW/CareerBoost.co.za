...
const SCRIPTS = [
  ...
  "./src/js/marketing/promo-state.js",
  ...
  "./src/js/modules/settings/settings.shared.js",
  "./src/js/modules/settings/settings.appearance.js",
  "./src/js/modules/settings/settings.ai.js",
  "./src/js/modules/settings/settings.jobprefs.js",
  "./src/js/modules/settings/settings.profile.js",
  ...
  // #/admin replaces it. admin.mfa.js is KEPT: the Console reuses
  // CBAdmin.mfa for its MFA gate and CBAdmin.access for the nav link.
